...
WaveSurfer.IrcamSegment = {
    scriptBufferSize: 256,
    PLAYING_STATE: 0,
    PAUSED_STATE: 1,
    FINISHED_STATE: 2,

    supportsIrcamSegment: function() {
        return !!(window.AudioContext || window.webkitAudioContext);

    },

    getAudioContext: function() {
        if (!WaveSurfer.IrcamSegment.audioContext) {
            this.wavesAudio = require('waves-audio'); // _MD_
            this.wavesLoaders = require('waves-loaders');
            // _MD_ // WaveSurfer.IrcamSegment.audioContext = new (
            // _MD_ //    window.AudioContext || window.webkitAudioContext
            // _MD_ //);
            //console.log("getAudioContext: " + this.wavesAudio.audioContext); // _MD_
            WaveSurfer.IrcamSegment.audioContext = this.wavesAudio.audioContext; // _MD_
        }

        return WaveSurfer.IrcamSegment.audioContext;
    },

    getOfflineAudioContext: function(sampleRate) {
        if (!WaveSurfer.IrcamSegment.offlineAudioContext) {
            WaveSurfer.IrcamSegment.offlineAudioContext = new(
                window.OfflineAudioContext || window.webkitOfflineAudioContext
            )(1, 2, sampleRate);
        }
        return WaveSurfer.IrcamSegment.offlineAudioContext;
    },
    ...
    init: function(params) {
        ...
        this.states = [
            Object.create(WaveSurfer.IrcamSegment.state.playing),
            Object.create(WaveSurfer.IrcamSegment.state.paused),
            Object.create(WaveSurfer.IrcamSegment.state.finished)
        ];
    ...
    destroy: function() {
        ...
        if (this.params.closeAudioContext) {
            ...
            if (!this.params.audioContext) {
                WaveSurfer.IrcamSegment.audioContext = null;
            } else {
                this.params.audioContext = null;
            }
            // clear the offlineAudioContext
            WaveSurfer.IrcamSegment.offlineAudioContext = null;
        }
    },
    ...
    createSource: function() {
        ...
        function setupSegmentPlayer() {
            ...
            loader.load(assets).then(function(loaded) {
                ...
                /*var eighthBeatDuration = audioBuffer.duration / 4;
                console.log(eighthBeatDuration);
                // get scheduler and create scheduled segment engine
                var scheduler = self.wavesAudio.getScheduler();
                self.scheduledSegmentEngine = new self.wavesAudio.SegmentEngine({
                    buffer: audioBuffer,
                ...
                self.scheduledSegmentEngine.connect(WaveSurfer.IrcamSegment.audioContext.destination);*/
                ...
                self.transportedSegmentEngine.connect(WaveSurfer.IrcamSegment.audioContext.destination);
        ...
        function setupMetronome() {
            ...
            self.metronome.connect(WaveSurfer.IrcamSegment.audioContext.destination);
        }
...
WaveSurfer.IrcamSegment.state = {};

WaveSurfer.IrcamSegment.state.playing = {
    init: function() {
...
WaveSurfer.IrcamSegment.state.paused = {
    ORIGinit: function() {
...
WaveSurfer.IrcamSegment.state.finished = {
    init: function() {
...
WaveSurfer.util.extend(WaveSurfer.IrcamSegment, WaveSurfer.Observer);
