...
wavesurfer.on('ready', function() {
    ...
    // create GUI elements
    new wavesBasicControllers.Title("Pitch Detection (Detects pitch at selected position)", pitchContainerId);
    ...
    new wavesBasicControllers.Slider("Position Var", 0, 0.200, 0.001, 0.01, "sec", '', containerId, function(value) {
        //self.scheduledGranularEngine.positionVar = value;
        self.transportedGranularEngine.positionVar = value;
    });

    new wavesBasicControllers.Slider("Period", 0.001, 0.500, 0.001, 0.001, "sec", '', containerId, function(value) {
        //self.scheduledGranularEngine.periodAbs = value;
        self.transportedGranularEngine.periodAbs = value;
    });

    new wavesBasicControllers.Slider("Duration", 0.010, 0.500, 0.001, 0.2, "sec", '', containerId, function(value) {
